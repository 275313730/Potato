...
export default class Render {
  ...
  public drawTexture(transform: Transform, textureRect: TextureRect, drawFn: Function) {
  ...
  public drawClipImage(transform: Transform, textureRect: TextureRect, clipRect: Rect) {
    this.drawTexture(transform, textureRect, (finalRect: Rect) => {
      this.context.drawImage(textureRect.texture, clipRect.x, clipRect.y, clipRect.width, clipRect.height, finalRect.x, finalRect.y, finalRect.width, finalRect.height);
    })
  }
